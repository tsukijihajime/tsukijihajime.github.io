...
document.write(
	...
	'    <ul class="footer-nav">',
	'<li class="navpick-rpa menu-item menu-item-type-post_type menu-item-object-page menu-item-99">取扱商品紹介</li>',
	...
	'<li id="menu-item-686" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-686">プロダクトソリューション</li>',
	'     </ul>',
